...
module.exports = function (db) {
  ...
  router.post('/add', function (req, res) {
    let date;
      const { generate, custom_date, tanggal, supplier, barang, tambah_stok } = req.body
      ...
      if (generate == 'off') {
        ...
        db.query(`INSERT INTO pembelian(no_invoice_beli, tanggal_pembelian,
         ...
         db.query(`INSERT INTO pembelian_detail(id_varian, qty) 
          ...
          db.query(`UPDATE varian SET stok_varian = $1 WHERE id_varian = $2`, [total_stok, barang], (err) => {
          if (err) {
            return console.error(err.message);
          }
          res.redirect('/barang_masuk')
